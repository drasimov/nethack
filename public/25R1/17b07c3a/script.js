...
const realEstatePrices = [30000, 50000, 80000, 120000, 200000, 350000, 500000, 700000, 900000, 1200000, 1500000, 2000000];
...
function updateUI() {
    ...
    for (let i = 0; i < numRealEstates; i++) {
        ...
        document.getElementById(`real-estate-ownership-${i}`).textContent = realEstateOwnership[i] ? 'Owned' : 'Not Owned';
